...
class MainApplication : Application(), Application.ActivityLifecycleCallbacks {
    ...
    fun retrieveFlagFromSharedPreferences(context: Context, flagKey: String): Boolean {
    ...
    override fun onCreate() {
        ...
        val isFlagSet = retrieveFlagFromSharedPreferences(this, "isLoggedIn")
        if(isFlagSet) {
...
//        CleverTapAPI.setNotificationHandler(PushTemplateNotificationHandler() as NotificationHandler);
    ...
    fun saveFlagToSharedPreferences(context: Context, flagKey: String, flagValue: Boolean) {
        val sharedPreferences = context.getSharedPreferences("is_login", Context.MODE_PRIVATE)
